...
ISUCON_PDNS_DB_HOST=${ISUCON13_PDNS_MYSQL_ADDRESS:-127.0.0.1}
ISUCON_PDNS_DB_PORT=${ISUCON13_PDNS_MYSQL_PORT:-3306}
ISUCON_PDNS_DB_USER=${ISUCON13_PDNS_MYSQL_USER:-isudns}
ISUCON_PDNS_DB_PASSWORD=${ISUCON13_PDNS_MYSQL_PASSWORD:-isudns}
ISUCON_PDNS_DB_NAME=${ISUCON13_PDNS_DATABASE:-isudns}
